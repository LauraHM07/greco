 ...
 */
final class Version20231214204100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE historial (id INT AUTO_INCREMENT NOT NULL, prestado_por_id INT DEFAULT NULL, prestado_a_id INT DEFAULT NULL, devuelto_por_id INT DEFAULT NULL, material_id INT DEFAULT NULL, fecha_hora_prestramo DATE NOT NULL, fecha_hora_devolucion DATE DEFAULT NULL, notas VARCHAR(255) DEFAULT NULL, INDEX IDX_269506527FF7B85C (prestado_por_id), INDEX IDX_26950652D6801257 (prestado_a_id), INDEX IDX_26950652622069E2 (devuelto_por_id), INDEX IDX_26950652E308AC6F (material_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, localizacion_id INT DEFAULT NULL, material_padre_id INT DEFAULT NULL, persona_id INT DEFAULT NULL, responsable_id INT DEFAULT NULL, prestado_por_id INT DEFAULT NULL, codigo VARCHAR(255) NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, fecha_hora_ultimo_prestamo DATE DEFAULT NULL, fecha_hora_ultima_devolucion DATE DEFAULT NULL, disponible TINYINT(1) NOT NULL, fecha_alta DATE DEFAULT NULL, fecha_baja DATE DEFAULT NULL, INDEX IDX_7CBE7595C851F487 (localizacion_id), INDEX IDX_7CBE759527E4C8FA (material_padre_id), INDEX IDX_7CBE7595F5F88DB9 (persona_id), INDEX IDX_7CBE759553C59D72 (responsable_id), INDEX IDX_7CBE75957FF7B85C (prestado_por_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE material ADD CONSTRAINT FK_7CBE759527E4C8FA FOREIGN KEY (material_padre_id) REFERENCES material (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material DROP FOREIGN KEY FK_7CBE759527E4C8FA');
